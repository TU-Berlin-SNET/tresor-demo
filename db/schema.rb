...
ActiveRecord::Schema.define(:version => 20130517133446) do
  ...
  create_table "broker_configurations", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "conflict_illnesses", :force => true do |t|
  ...
  create_table "conflict_meds", :force => true do |t|
    t.string   "description"
  ...
  create_table "illnesses_patients", :id => false, :force => true do |t|
  ...
  create_table "medicaments_patients", :id => false, :force => true do |t|
    t.integer "medicament_id"
    t.integer "patient_id"
  end
  ...
  create_table "proxy_configurations", :force => true do |t|
    t.string   "name"
    t.boolean  "ad_linkup"
